...
begin
     ...
     MyImg.Canvas.Brush.Color := clBtnFace; //÷вет заливки окружности
     MyImg.Canvas.Pen.Color := clBtnFace; //÷вет самой окружности (точнее границ)
     MyImg.Canvas.Rectangle(0, 0, MyImg.Width, MyImg.Height); // р
  //   MyImg.Canvas.Brush.Color := clSilver; //÷вет заливки окружности
     MyImg.Canvas.Pen.Color := clBlack; //÷вет самой окружности (точнее границ)
